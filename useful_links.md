### HH.ru и работа с API

- [API hh.ru. Быстрый старт](https://habr.com/ru/companies/hh/articles/303168/)
- [docs hh.ru]( https://api.hh.ru/openapi/redoc#tag/Poisk-vakansij/operation/get-vacancies)
...
### Теория (ML, BERT, NLP, трансформеры)
...
- [BERT в двух словах: Инновационная языковая модель для NLP](https://habr.com/ru/companies/otus/articles/702838/)
- [Что такое векторизация текста в NLP и какая она бывает: One-hot encoding, Bag of words, TF-IDF, Word2Vec, BERT и другие](https://habr.com/ru/articles/820159/)
...
- https://vestnik.rsreu.ru/images/archive/2023/85/3.5_.pdf
...
- [Streamlit 101 Series' Articles 8 parts](https://dev.to/jamesbmour/series/28657)
...
### Аналоги и исследовательские платформы
...
- [АНАЛОГ англ2](https://www.onetonline.org/)
- [АНАЛОГ РосНавык](https://rosnavyk.ru/)

### Нейронные сети и обучение моделей
...
- [Модели BERT для машинного обучения: гайд для начинающих](https://habr.com/ru/companies/skillfactory/articles/862130/)

### Прочее (Git, DLT, инфраструктура, оформление)
...
- [google presentation templates](https://docs.google.com/presentation/u/1/?ftv=1&folder=1LUABDlYBWpwbdYWG63887Un2EL3eeQ3T)
- [List of column-oriented DB](https://en.wikipedia.org/wiki/List_of_column-oriented_DBMSes)
- [dlt (что-то классное)](https://dlthub.com/)
- ### Крутая статья ниже!
- [**Утиные истории со стрелами на паркете**](https://habr.com/ru/articles/597943/)
- [презентация Вова] https://docs.google.com/presentation/d/1UfwKcJ4dDCN-FuMLjT7qNJr-Ko4w1l3yvRuY5wWme-I/edit?slide=id.g2e04f14b91a_0_251#slide=id.g2e04f14b91a_0_251
